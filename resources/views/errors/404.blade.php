...
box-shadow: 4px 4px 5px 0px rgba(0,0,0,0.5);">
             ...
             <h4 class=" text-center bg-danger" style="padding:5px;">This is not the page you are looking for. </h4>
           <h1 class=" text-center bg-danger"  style="padding:5px;">ERROR Code: <code> 404 </code> </h1>
                                     
                                        <h6 class="panel-title  text-center"  style="padding:5px;">Click to Proceed for Loginor Control Panel</h6>                                    <div class="btn-group btn-group-justified" role="group" aria-label="...">
