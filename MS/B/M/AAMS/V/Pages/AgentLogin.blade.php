...
box-shadow: 4px 4px 5px 0px rgba(0,0,0,0.5);">
                   ...
                   <i class="fa fa-user-secret fa-4x" aria-hidden="true"></i>
                        <h5 class="panel-title  text-center">Sign in with your Agent Credential
                    ...
                    <div class="panel-body">
                        ...
                        <br>
                        {!! Form::open(['route' => 'AAMS.Agent.Login.Post','method' => 'post','files' => true,'class'=>'ms-form']) !!}
                            <fieldset class="col-lg-10 col-lg-offset-1">
                             ...
                             <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-building" aria-hidden="true"></i>  <small> Agency </small></div>
                                     ...
                                     // dd(  );
                                      ...
                                      $data=$m->MS_all()->pluck('Name','UniqId')->toArray();
                                        ...
                                        echo Form::select("AgencyCode" ,$data,null,['class'=>"form-control"]) ;
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i><small> Username</small></div>
                                 ...
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon "><i class="fa fa-unlock-alt" aria-hidden="true"></i> <small>Password</small></div>
